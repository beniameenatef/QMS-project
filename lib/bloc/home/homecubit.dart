...
import 'package:design_ui/models/Mstaffmodel.dart';
...
class homecubit extends Cubit<qualityhomestates> {
  ...
  Future<Mstaff?> PostMstaff({String ?name, String? job}) async {
    ...
    await http.post((Uri.parse(api)), headers:<String , String> {
      //'Authorization' : 'xyz',
      'Content-Type': 'application/json; charset=UTF-8',
    },
        body: jsonEncode(<String,dynamic>{
  ...
  Future<Mstaff?> PutMstaff({int? id, String? name, String ?job}) async {
    ...
    await http.put((Uri.parse(api)), headers:<String , String> {
      //'Authorization' : 'xyz',
      'Content-Type': 'application/json; charset=UTF-8',
    },
        body: jsonEncode(<String,dynamic>{
  ...
  Future<Mstaff?> DeleteMstaff({int? id}) async {
    ...
    await http.delete(Uri.parse('https://qms-application.herokuapp.com/api/m-staffs/${id}'))
    .then((value)
    {
      if(value.statusCode==200){
        print(value.body);
  ...
  Future<Researches?> DeleteResearch({int? id}) async {
    ...
    await http.delete(Uri.parse('https://qms-application.herokuapp.com/api/researches/${id}?populate=*'))
    .then((value)
    {
      if(value.statusCode==200){
        print(value.body);
  ...
  emit(qualitypoststudentdistributionloadingstate());
    ...
    ).then((value)
    {
      if (value.statusCode == 200) {
        var data = jsonDecode(value.body.toString());
        print(data);
         modelStudentdistribution=StudentDistribution.fromJson(jsonDecode(value.body));
  ...
  Future<StudentDistribution?> DeleteStudentDistrubtion({int? id}) async {
    emit(qualitydeletestudentdistributionloadingstate());
     await http.delete(Uri.parse('https://qms-application.herokuapp.com/api/student-distributions/${id}?populate=*'))
    .then((value)
    {
      if(value.statusCode==200){
        print(value.body);
   ...
   emit(qualitypoststudenttransactionloadingstate());
    ...
    ).then((value)
    {
      if (value.statusCode == 200) {
        var data = jsonDecode(value.body.toString());
        print(data);
         modelstudenttransaction= StudentTransaction.fromJson(jsonDecode(value.body));
  ...
  Future<StudentTransaction?> PutStudentTransaction({int ?id, int ?percentage, int ?year, int? survey}) async {
    ...
    dynamic api = 'https://qms-application.herokuapp.com/api/student-transactions/${id}?populate=*';
     http.put((Uri.parse(api)), headers:<String , String> {
      //'Authorization' : 'xyz',
      'Content-Type': 'application/json; charset=UTF-8',
    },
        body: jsonEncode(<dynamic,dynamic>{
  ...
  Future<SurveyItems?> DeleteSurveyItem({int? id}) async {
    ...
    await http.delete(Uri.parse('https://qms-application.herokuapp.com/api/survey-items/${id}?populate=*'))
    .then((value)
    {
      if(value.statusCode==200){
        print(value.body);
  ...
  Future<Surveys?> DeleteSurvey({int? id}) async {
    ...
    await http.delete(Uri.parse('https://qms-application.herokuapp.com/api/surveys/${id}'))
    .then((value)
    {
      if(value.statusCode==200){
        print(value.body);
